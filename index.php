...
<head>
    ...
    <title>Booking Kenya | Your all-in-one booking app</title>
</head>
        ...
        <header class="header">
            ...
            <nav class="user-nav">
                ...
                <div class="user-nav__user">
                    ...
                    <span class="user-nav__user-name">Ryan</span>
                </div>
            </nav>
        </header>
            ...
            <main class="hotel-view">
                ...
                <div class="overview">
                    ...
                    <div class="overview__location">
                        ...
                        <button class="btn-inline">Mombasa, Kenya</button>
                    </div>
                    ...
                    <div class="user-reviews">
                        <figure class="review">
                            ...
                            <figcaption class="review__user">
                                ...
                                <div class="review__user-box">
                                    <p class="review__user-name">Nick Sam</p>
                        ...
                        <figure class="review">
                            ...
                            <figcaption class="review__user">
                                ...
                                <div class="review__user-box">
                                    <p class="review__user-name">Mary Wanjiru</p>
                                    <p class="review__user-date">Jan 13th, 2021</p>
                                </div>
